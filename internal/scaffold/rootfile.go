...
// GenerateRootREADME 生成仓库根 README.md，标题为项目名。projectName 由调用方传入（defaultProjectName 推导）。
func GenerateRootREADME(absRoot, projectName string) error {
	content := fmt.Sprintf("# %s\n\nGenerated by gocli create project.\n", projectName)
	return os.WriteFile(filepath.Join(absRoot, "README.md"), []byte(content), 0o644)
}
