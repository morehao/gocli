...
import (
	...
	"github.com/morehao/example/apps/demoapp/internal/dto/dtouser"
	"github.com/morehao/example/apps/demoapp/internal/service/svcuser"
...
// @Param req body dtouser.UserCreateReq true "创建用户登录记录"
